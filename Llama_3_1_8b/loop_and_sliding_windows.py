...
steady_times = token_times[5:]  # Ignore the first 5 tokens
...
print(type(outputs.past_key_values)) # Check if using 100% KV CACHE the result gonna be = transformers.cache_utils.DynamicCache
